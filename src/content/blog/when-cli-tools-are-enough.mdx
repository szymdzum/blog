...
> **Warning:** Before letting any agent run database commands, make sure you have a backup. Stories of agents wiping production databases are not urban legends. Use read-only connections where possible, sandbox test data, and never give write access to anything you can't restore.
